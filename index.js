...
/////////////////
const BotName = 'RISSA STORE'; 
const instagram = 'https://instagram.com/holaa023_.id'; 
const telegram = 'https://t.me/Cherry Clarissa'; 
const kapanbotaktif = 'BOT AKTIF'; 
const youtube = 'https://www.youtube.com/c/Cherry Clarissa_id';
//const grupch1 = 'https://chat.whatsapp.com/IzdT6rNb3hZK8U7txKpblz'; 
...
conn.on('user-presence-update', json => console.log(json.id + ' presence is => ' + json.type)) || console.log('Bot by Rissa Store')
conn.on('message-status-update', json =>
{
   const participant = json.participant ? ' (' + json.participant + ')' : '' // participant exists when the message is from a group
   console.log(`[ ${moment().format("HH:mm:ss")} ] => bot by Rissa Store`)
})
